<template>
    <div class="article">
        <div class="container py-13 py-lg-15">
            <h2 class="sb-section-title-primary mb-6 d-block d-lg-none">精選文章</h2>
            <div class="row">
                <div class="col-lg-3 order-1 order-lg-0">
                    <div class="d-lg-flex flex-column h-100 justify-content-lg-between">
                        <h2 class="sb-section-title-primary d-lg-block d-none">精選文章</h2>
                        <btnPagination></btnPagination>
                    </div>
                </div>
                <div class="col">
                    <div class="row mb-11 mb-lg-0">
                        <div class="col-lg-6" v-for=" data in datas" :key="data.id">
                            <!-- card -->
